      ...
      <View className="h-full px-5">
        <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
          ...
          <View className="w-full flex-col justify-start items-start pb-5">
            ...
            <Text className="text-2xl font-bold text-nhs-light-green" style={{lineHeight:25}}>Summary of Key Points</Text>
            ...
            <Text className="text-2xl font-bold text-nhs-light-green" style={{lineHeight:25}}>Table of Contents</Text>
            ...
            <Text className="text-lg font-bold text-nhs-light-green" style={{lineHeight:20}}>1. WHAT INFORMATION DO WE COLLECT?</Text>
            ...
            <Text className="text-lg font-bold text-nhs-light-green" style={{lineHeight:20}}>2. HOW DO WE PROCESS YOUR INFORMATION?</Text>
            ...
            <Text className="text-lg font-bold text-nhs-light-green" style={{lineHeight:20}}>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</Text>
            ...
            <Text className="text-lg font-bold text-nhs-light-green" style={{lineHeight:20}}>4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</Text>
            <Text className="text-md text-nhs-black mb-4 italic"><Text className="font-[900] italic">In Short: </Text>We may share information in specific situations described in this section and/or with the following third parties.</Text>
            ...
            <Text className="text-lg font-bold text-nhs-light-green" style={{lineHeight:20}}>5. HOW LONG DO WE KEEP YOUR INFORMATION?</Text>
            ...
            <Text className="text-lg font-bold text-nhs-light-green" style={{lineHeight:20}}>6. DO WE COLLECT INFORMATION FROM MINORS?</Text>
            ...
            <Text className="text-lg font-bold text-nhs-light-green" style={{lineHeight:20}}>7. WHAT ARE YOUR PRIVACY RIGHTS?</Text>
            ...
            <Text className="text-lg font-bold text-nhs-light-green" style={{lineHeight:20}}>8. CONTROLS FOR DO-NOT-TRACK FEATURES</Text>
            ...
            <Text className="text-lg font-bold text-nhs-light-green" style={{lineHeight:20}}>9. DO WE MAKE UPDATES TO THIS NOTICE?</Text>
            ...
            <Text className="text-lg font-bold text-nhs-light-green" style={{lineHeight:20}}>10. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</Text>
            ...
            <Text className="text-lg font-bold text-nhs-light-green" style={{lineHeight:20}}>11. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</Text>
